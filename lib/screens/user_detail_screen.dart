...
class UserDetailPage1 extends ConsumerStatefulWidget {
  final types.User user;
  UserDetailPage1({required this.user});

  @override
  ConsumerState<UserDetailPage1> createState() => _UserDetailPageState1();
}

class _UserDetailPageState1 extends ConsumerState<UserDetailPage1> {
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: widget.user.metadata!['email'] ?? 'email',
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: widget.user.firstName ?? 'username',
                          prefixIcon: Icon(Icons.mail),
                          border: InputBorder.none,
                        ),
                      ),
                      ...
                      if (emailController.text.isNotEmpty &&
                        ...
                        try {
                          await FirebaseAuth.instance.currentUser!
                              ...
                              .then((value) async {
                                await userDb.doc(widget.user.id).update(
                        ...
                        SnackShow.showFailure(
                            context, 'Cannot leave the field empty');
                      }
                    },
